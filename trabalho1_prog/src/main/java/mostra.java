...
public class mostra extends javax.swing.JFrame {
    ...
    public mostra(ArrayList<Aluno> infAlun, ArrayList<Tecnico> infTecn, 
    ArrayList<Funcionario> infFun, ArrayList<Professor> infProf,ArrayList<Curso> infCursos,
    int nus,ArrayList<Diciplinas> infDici) {
        initComponents();
        infoAluno=infAlun;
        infoTec=infTecn;
        infoFunci=infFun;
    ...
    public void mostraDados(int nu){
        ...
        switch(nu){
            case 1:
                        ...
                        lista.addElement(infoAluno.get(i));
                        }
                        listas.setModel(lista);
            break;
            case 2:
                        for(int i=0;i<infoTec.size();i++){
                        lista.addElement(infoTec.get(i));
                        }
                        listas.setModel(lista);
            break;
            case 3:
                        for(int i=0;i<infoFunci.size();i++){
                        lista.addElement(infoFunci.get(i));
                        }
                        listas.setModel(lista);
            break;
            case 4:
                        for(int i=0;i<infoPro.size();i++){
                        lista.addElement(infoPro.get(i));
                        }
                        listas.setModel(lista);
            break;
            case 5:
                        for(int i=0;i<infoCurso.size();i++){
                        lista.addElement(infoCurso.get(i));
                        }
                        listas.setModel(lista);
            break;
            case 6:
                        for(int i=0;i<infoDic.size();i++){
                        lista.addElement(infoDic.get(i));
                        }
                        listas.setModel(lista);
            break;
        }
